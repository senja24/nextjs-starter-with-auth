...
import { unknownError } from "@/config/defaults"
import { emailSchema, type EmailSchema } from "@/validations/notification"
        ...
        try {
            const response = await fetch("/api/email/newsletter", {
                ...
                body: JSON.stringify({
                    ...
                    subject: "Welcome to Jajan Digital",
                }),
            })
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="relative space-y-0">
                            ...
                            <FormControl>
                                <Input
                                    placeholder="halo@jajandigital.id"
                                    className="pr-12"
                                    {...field}
                                />
                            </FormControl>
